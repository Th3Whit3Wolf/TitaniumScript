...
mod binary {
    ...
    fn lower_with_decimal() {
        check(
            "0b1010.01",
            TokenKind::Literal(LiteralKind::Float { base: Base::Binary, empty_exponent: true }),
        )
    }
...
mod decimal {
    ...
    fn with_decimal() {
        check(
            "200.002",
            TokenKind::Literal(LiteralKind::Float { base: Base::Decimal, empty_exponent: true }),
        )
    }
...
mod octal {
    ...
    fn lower_with_decimal() {
        check(
            "0o123.01",
            TokenKind::Literal(LiteralKind::Float { base: Base::Octal, empty_exponent: true }),
        )
    }
