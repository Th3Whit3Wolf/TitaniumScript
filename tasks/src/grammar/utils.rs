...
pub(crate) fn add_preamble(generator: &'static str, mut text: String) -> String {
...
pub(crate) fn ensure_rustfmt(sh: &Shell) {
...
pub(crate) fn deduplicate_fields(ast: &mut AstSrc) {
...
pub(crate) fn write_doc_comment(contents: &[String], dest: &mut String) {
    for line in contents {
        writeln!(dest, "///{line}").unwrap();
    }
}

pub(crate) fn titaniumscript_grammar() -> Grammar {
